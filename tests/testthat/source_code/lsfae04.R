...
## R version:                 4.5.2
## junco Version:             0.1.3
## Short Description:         Program to create lsfae04: Listing of Adverse Events
##                            Leading to Death
...
lsting <- lsting %>%
  ...
  mutate(
    ...
    COL10 = paste(AETOXGR, AESER, sep = concat_sep),
...
colwidth <- c(18, 13, 65, 23, 38, 8, 24, 24, 22, 22, 15, 11)
