...
## Program Name:              lsfae07b.r
## R version:                 4.5.2
## junco Version:             0.1.3
## Short Description:         Program to create lsfae07b: Selected [Narrow / Broad] OCMQs
## Author:                    C&SP Methodology
## Date:                      2026-09-30
## Input:                     adaeocmq
## Output:                    lsfae07b.rtf
## Remarks:                   This variant is for Toxicity
## R-functions:
...
lsting <- lsting %>%
  ...
  mutate(
    ...
    COL8 = paste(AEOUTC, AETOXGR, AESER, sep = concat_sep)
  ) %>%
  arrange(
    COL0,
    COL1,
