...
## Program Name:              tsfae10b.r
## R version:                 4.5.2
## junco version:             0.1.3
## Short Description:         Program to create tsfae10b: Demographic Characteristics
##                            for Subjects With Serious Treatment-emergent Adverse Events
