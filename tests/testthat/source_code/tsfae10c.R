...
## Program Name:              tsfae10c.r
## R version:                 4.5.2
## junco version:             0.1.3
## Short Description:         Program to create tsfae10c: Demographic Characteristics
...
adsl <- adsl_jnj %>%
  ...
  mutate(
    ...
    # Age Group: include Unknown
    AGEGR1 = forcats::fct_na_value_to_level(
      AGEGR1,
      level = "Unknown"
    )
  ) %>%
