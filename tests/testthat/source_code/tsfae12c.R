...
## Program Name:              tsfae12c.r
## R version:                 4.5.2
## junco Version:             0.1.3
## Short Description:         Program to create tsfae12c: Subjects With Treatment-emergent
##                            Adverse Events by System Organ Class, Preferred Term, and Age
