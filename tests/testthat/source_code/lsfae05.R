...
## R version:                 4.5.2
## junco Version:             0.1.3
## Short Description:         Program to create lsfae05: Listing of Treatment-emergent
##                            Adverse Events of Special Interest by AE Grouping
...
lsting <- var_relabel(
  lsting,
  COL0 = "AE of Special Interest Category", #"Special" is optional
